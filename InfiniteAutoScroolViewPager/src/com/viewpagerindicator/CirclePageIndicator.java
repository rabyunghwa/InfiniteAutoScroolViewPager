...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	protected void onDraw(Canvas canvas) {
		System.out.println("  onDraw  mCurrentPage = "+mCurrentPage+"  snap is "+mSnap);
		super.onDraw(canvas);
		...
		final float shortOffset = shortPaddingBefore + mRadius;// 上边坐标
		float longOffset = longPaddingBefore + mRadius;// 左边坐标
		if (mCentered) {
